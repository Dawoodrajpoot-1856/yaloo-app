    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div
            key={i}
            className="bg-white rounded-2xl p-5 shadow-md border border-gray-300 hover:-translate-y-3 hover:border-amber-200 transition-all duration-500"
          >
            {/* HEADER */}
      ...
      {/* CTA SECTION */}
      <div className="bg-[#393a36] mt-16 rounded-3xl px-6 sm:px-10 py-12 flex flex-col lg:flex-row items-center justify-between gap-10">
        {/* LEFT */}
        <div className="max-w-xl">
          ...
          <button className="group bg-yellow-400 text-black hover:bg-black hover:text-white transition px-5 py-3 rounded-2xl flex items-center gap-3 font-semibold">
            ...
            <span className="relative w-5 h-5 flex items-center justify-center overflow-hidden">
              <ArrowUpRight className="absolute text-black group-hover:opacity-0 group-hover:-translate-y-3 transition" />

              <ArrowRight className="absolute opacity-0 translate-y-3 text-white group-hover:opacity-100 group-hover:translate-y-0 transition" />
            </span>
          </button>
        </div>
