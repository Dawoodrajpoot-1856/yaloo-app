  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-6 mt-8">
        ...
        {/* SEARCH BUTTON */}
        <div className="group inline-flex items-center justify-center gap-2 px-5 h-12 rounded-2xl bg-yellow-300 hover:bg-black transition-all duration-300 cursor-pointer w-full sm:w-fit">
